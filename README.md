...
- [API Spec Converter](https://github.com/lucybot/api-spec-converter) - A command-line tool and NodeJS package that converts other API description formats (e.g. I/O Docs and API Blueprint) into Swagger
