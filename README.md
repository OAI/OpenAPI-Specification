...
- [swaggerize-express](https://github.com/krakenjs/swaggerize-express) - A design-first approach to building RESTful service with swagger and express.
- [swaggerize-hapi](https://github.com/krakenjs/swaggerize-hapi) - Design first API development in Hapi.
- [generator-swaggerize](https://github.com/krakenjs/generator-swaggerize) - Yeoman generator for swagger application with krakenjs/swaggerize tools.
