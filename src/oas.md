...
The OpenAPI Schema Object dialect for this version of the specification is identified by the URI `https://spec.openapis.org/oas/3.3/dialect/YYYY-MM-DD` (the <a name="dialect-schema-id"></a>"OAS dialect schema id").
