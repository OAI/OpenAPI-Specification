...
<a name="operationDeprecated"></a>deprecated | `boolean` | Declares this operation to be deprecated. Usage of the deprecated operation should be refrained. Default value is `false`.
