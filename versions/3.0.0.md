...
The schema defines two types of fields: fixed fields with explicitly declared names, and patterned fields that use regular expressions to match field names.
