...
- maxLength
- minLength
- pattern (This string SHOULD be a valid regular expression, according to the [Ecma-262 Edition 5.1](https://www.ecma-international.org/ecma-262/5.1/#sec-7.8.5) regular expression dialect)
- maxItems
- minItems
- uniqueItems
- maxProperties
