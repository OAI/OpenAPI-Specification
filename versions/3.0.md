...
<a name="operationDeprecated"></a>deprecated | `boolean` | Declares this operation to be deprecated. Clients should refrain from usage of the declared operation. Default value is `false`.
