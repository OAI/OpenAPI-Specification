...
Contrary to _dynamic_ links (links provided **in** the response payload), the OAS linking mechanism does not require link information in a specific response format at runtime.
...
Because of the potential for name clashes, the `operationRef` syntax is the preferred 
