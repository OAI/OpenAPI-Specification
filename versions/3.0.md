...
Request body           | `$request.body`    | `/users/{$request.body#/user/uuid}` | For operations which accept payloads, references MAY be made to portions of the `requestBody` or the entire body.
