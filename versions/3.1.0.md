...
<a name="oauthFlowsDeviceCode"></a>deviceCode| [OAuth Flow Object](#oauthFlowObject) | Configuration for the OAuth Device Code flow.
...
<a name="oauthFlowDeviceAuthorizationUrl"></a>deviceAuthorizationUrl | `string` | `oauth2` (`"deviceCode"`) | **REQUIRED**. The device authorization URL to be used for this flow. This MUST be in the form of a URL. The OAuth2 standard requires the use of TLS.
