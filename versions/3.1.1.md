...
##### <a name="style-values"></a>Style Values
...
##### <a name="runtime-expression"></a>Runtime Expressions
...
##### <a name="base-vocabulary"></a>Fixed Fields
...
Version   | Date       | Notes
---       | ---        | ---
3.1.1     | 2022-01-03 | Patch release of the OpenAPI Specification 3.1.1
