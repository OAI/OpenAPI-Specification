...
Status codes are defined in [RFC7231](https://tools.ietf.org/html/rfc7231#section-6) and the available status codes are registered in the [IANA Status Code Registry](https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml).
