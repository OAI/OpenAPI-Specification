...
<a name="securitySchemeoauth2MetadataUrl"></a>oauth2MetadataUrl | `string` | `oauth2` |A HTTPS URL to discover OAuth2 configuration values. This must be in the form of a URL. See [RFC8414](https://datatracker.ietf.org/doc/html/rfc8414).
